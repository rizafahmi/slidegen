defmodule SlidegenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SlidegenWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SlidegenWeb.Gettext, "errors", msg, opts)
    # end
